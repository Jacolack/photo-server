...
?>
    ...
    <div class="createDiv">
	<center>
        <p class="orLbl">Your image has been uploaded.</p>
	<br>
	<a class="createPicker" href="/index.php?location=<?php echo $GETLocation;?>">View in Enclosing Folder</a>
	<br>
	<br>
	<a class="createPicker" href="/createFolder.php">Create Folder</a>
	<br>
	<br>
	<a class="createPicker" href="/upload.php">Upload Another Image</a>
	</center>
